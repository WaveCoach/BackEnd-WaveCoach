...
<div class="card">
    <div class="card-body">
        <h5 class="card-title">Tambah mastercoach baru</h5>
        <p class="card-description">Halaman ini memungkinkan admin untuk menambahkan mastercoach baru</p>
        <form method="POST" action="{{ route('mastercoach.store') }}" id="jobPositionForm">
            @csrf
            <div class="row mb-4">
                <!-- Select2 untuk Kategori -->
                <div class="col-6 mb-3">
                    <label for="assesment_categories_id" class="form-label">Nama</label>
                    <select class="select2" required name="name" id="myselect">
