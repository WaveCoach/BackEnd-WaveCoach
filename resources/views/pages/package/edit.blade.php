...
<div class="card">
    <div class="card-body">
        ...
        <p class="card-description">Halaman ini memungkinkan admin untuk mengubah data package</p>
        @if ($errors->any())
        ...
        <form method="POST" action="{{ route('package.update', $package->id) }}">
            ...
            <div class="row mb-4">
                ...
                <div class="col-6 mb-3">
                    ...
                    <textarea class="form-control" name="desc" rows="3">{{ old('desc', $package->desc) }}</textarea>
                </div>
            </div>
